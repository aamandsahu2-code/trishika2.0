  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative h-22 md:h-50 bg-linear-to-b from-white/80 to-pink-200 w-full rounded-[40px] flex items-end justify-center shadow-inner overflow-hidden"
      >
